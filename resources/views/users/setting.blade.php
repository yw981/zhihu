                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/setting">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" class="form-control" name="city" value="{{ Auth::user()->settings['city'] }}"  required>
                                    @if ($errors->has('city'))
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="bio" type="text" class="form-control" name="bio"  required>{{ Auth::user()->settings['bio'] }}</textarea>
                                    @if ($errors->has('bio'))
                                        <span class="help-block">
